...
export const StockSearch = () => {
  ...
  return (
    <div>
      <div className="flex mt-3 pl-5 pr-4 justify-between mb-5">
        <div className="w-1/5">
          <div className="font-semibold mb-2.5 text-xl">
        ...
        <div className="w-1/5">
          ...
          <Select value={animal1} onChange={handleChange1} options={options} />
        </div>
        <div className="w-1/5">
          <div className="font-semibold mb-2.5 text-xl">
            Select output format:
          </div>
          <Select value={animal2} onChange={handleChange2} options={options} />
        </div>
        <button
          onClick={showGraphHandler}
          className="px-7 h-16 font-medium bg-indigo-500 text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] mt-2"
        >
          Get Details
        </button>
      </div>
